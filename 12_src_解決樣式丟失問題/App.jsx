      ...
      <div className="row">
        <div className="col-xs-2 col-xs-offset-2">
          <div className="list-group">
            ...
            <MyNavLink to="/hanaCafe/about" >About</MyNavLink>
            <MyNavLink to="/hanaCafe/home" >Home</MyNavLink>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="panel">
            <div className="panel-body">
                ...
                <Routes>
                    <Route path="/hanaCafe/about" element={<About/>}/>
                    <Route path="/hanaCafe/home" element={<Home/>}/>
                </Routes>
            </div>
          </div>
        </div>
